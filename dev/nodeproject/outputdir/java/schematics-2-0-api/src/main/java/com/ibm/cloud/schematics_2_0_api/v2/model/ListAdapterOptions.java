...
/**
 * The listAdapter options.
 */
public class ListAdapterOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListAdapterOptions listAdapterOptions) {
      this.offset = listAdapterOptions.offset;
      this.limit = listAdapterOptions.limit;
      this.sort = listAdapterOptions.sort;
      this.profile = listAdapterOptions.profile;
    }
    ...
    /**
     * Builds a ListAdapterOptions.
     *
     * @return the new ListAdapterOptions instance
     */
    public ListAdapterOptions build() {
      return new ListAdapterOptions(this);
    }
     ...
     * @return the ListAdapterOptions builder
     */
  ...
  protected ListAdapterOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListAdapterOptions builder
   */
