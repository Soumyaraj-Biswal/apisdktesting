...
/**
 * The listControls options.
 */
public class ListControlsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListControlsOptions listControlsOptions) {
      this.offset = listControlsOptions.offset;
      this.limit = listControlsOptions.limit;
      this.sort = listControlsOptions.sort;
      this.profile = listControlsOptions.profile;
    }
    ...
    /**
     * Builds a ListControlsOptions.
     *
     * @return the new ListControlsOptions instance
     */
    public ListControlsOptions build() {
      return new ListControlsOptions(this);
    }
     ...
     * @return the ListControlsOptions builder
     */
  ...
  protected ListControlsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListControlsOptions builder
   */
