...
/**
 * The getWorkspaceTemplateInputValue options.
 */
public class GetWorkspaceTemplateInputValueOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetWorkspaceTemplateInputValueOptions getWorkspaceTemplateInputValueOptions) {
      this.workspaceId = getWorkspaceTemplateInputValueOptions.workspaceId;
      this.templateId = getWorkspaceTemplateInputValueOptions.templateId;
      this.varName = getWorkspaceTemplateInputValueOptions.varName;
      this.offset = getWorkspaceTemplateInputValueOptions.offset;
      this.limit = getWorkspaceTemplateInputValueOptions.limit;
    }
    ...
    /**
     * Builds a GetWorkspaceTemplateInputValueOptions.
     *
     * @return the new GetWorkspaceTemplateInputValueOptions instance
     */
    public GetWorkspaceTemplateInputValueOptions build() {
      return new GetWorkspaceTemplateInputValueOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the GetWorkspaceTemplateInputValueOptions builder
     */
  ...
  protected GetWorkspaceTemplateInputValueOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetWorkspaceTemplateInputValueOptions builder
   */
