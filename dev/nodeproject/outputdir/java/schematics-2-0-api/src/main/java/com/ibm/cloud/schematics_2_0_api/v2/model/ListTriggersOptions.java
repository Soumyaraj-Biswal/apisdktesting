...
/**
 * The listTriggers options.
 */
public class ListTriggersOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListTriggersOptions listTriggersOptions) {
      this.offset = listTriggersOptions.offset;
      this.limit = listTriggersOptions.limit;
      this.sort = listTriggersOptions.sort;
    }
    ...
    /**
     * Builds a ListTriggersOptions.
     *
     * @return the new ListTriggersOptions instance
     */
    public ListTriggersOptions build() {
      return new ListTriggersOptions(this);
    }
     ...
     * @return the ListTriggersOptions builder
     */
  ...
  protected ListTriggersOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListTriggersOptions builder
   */
