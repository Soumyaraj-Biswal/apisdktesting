...
public class UpdateKmsSettingsOptions extends GenericModel {
  ...
  protected KMSSettings kmsSettings;

  /**
   * Builder.
   */
  public static class Builder {
    private KMSSettings kmsSettings;

    private Builder(UpdateKmsSettingsOptions updateKmsSettingsOptions) {
      this.kmsSettings = updateKmsSettingsOptions.kmsSettings;
    }
     ...
     */
    public Builder(KMSSettings kmsSettings) {
  ...
  protected UpdateKmsSettingsOptions(Builder builder) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(builder.kmsSettings,
      "kmsSettings cannot be null");
    kmsSettings = builder.kmsSettings;
  }
