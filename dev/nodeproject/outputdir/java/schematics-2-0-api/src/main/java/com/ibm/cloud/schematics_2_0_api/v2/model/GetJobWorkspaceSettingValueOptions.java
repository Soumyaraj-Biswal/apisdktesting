...
/**
 * The getJobWorkspaceSettingValue options.
 */
public class GetJobWorkspaceSettingValueOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetJobWorkspaceSettingValueOptions getJobWorkspaceSettingValueOptions) {
      this.jobId = getJobWorkspaceSettingValueOptions.jobId;
      this.workspaceId = getJobWorkspaceSettingValueOptions.workspaceId;
      this.varName = getJobWorkspaceSettingValueOptions.varName;
      this.offset = getJobWorkspaceSettingValueOptions.offset;
      this.limit = getJobWorkspaceSettingValueOptions.limit;
    }
    ...
    /**
     * Builds a GetJobWorkspaceSettingValueOptions.
     *
     * @return the new GetJobWorkspaceSettingValueOptions instance
     */
    public GetJobWorkspaceSettingValueOptions build() {
      return new GetJobWorkspaceSettingValueOptions(this);
    }
     ...
     *
     * @param jobId the jobId
     * @return the GetJobWorkspaceSettingValueOptions builder
     */
  ...
  protected GetJobWorkspaceSettingValueOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetJobWorkspaceSettingValueOptions builder
   */
