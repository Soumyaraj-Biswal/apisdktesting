...
/**
 * The getWorkspaceTemplateOutputValue options.
 */
public class GetWorkspaceTemplateOutputValueOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetWorkspaceTemplateOutputValueOptions getWorkspaceTemplateOutputValueOptions) {
      this.workspaceId = getWorkspaceTemplateOutputValueOptions.workspaceId;
      this.templateId = getWorkspaceTemplateOutputValueOptions.templateId;
      this.varName = getWorkspaceTemplateOutputValueOptions.varName;
      this.offset = getWorkspaceTemplateOutputValueOptions.offset;
      this.limit = getWorkspaceTemplateOutputValueOptions.limit;
    }
    ...
    /**
     * Builds a GetWorkspaceTemplateOutputValueOptions.
     *
     * @return the new GetWorkspaceTemplateOutputValueOptions instance
     */
    public GetWorkspaceTemplateOutputValueOptions build() {
      return new GetWorkspaceTemplateOutputValueOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the GetWorkspaceTemplateOutputValueOptions builder
     */
  ...
  protected GetWorkspaceTemplateOutputValueOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetWorkspaceTemplateOutputValueOptions builder
   */
