...
/**
 * The getCartOrderJob options.
 */
public class GetCartOrderJobOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetCartOrderJobOptions getCartOrderJobOptions) {
      this.orderId = getCartOrderJobOptions.orderId;
      this.jobId = getCartOrderJobOptions.jobId;
      this.offset = getCartOrderJobOptions.offset;
      this.limit = getCartOrderJobOptions.limit;
    }
    ...
    /**
     * Builds a GetCartOrderJobOptions.
     *
     * @return the new GetCartOrderJobOptions instance
     */
    public GetCartOrderJobOptions build() {
      return new GetCartOrderJobOptions(this);
    }
     ...
     *
     * @param orderId the orderId
     * @return the GetCartOrderJobOptions builder
     */
  ...
  protected GetCartOrderJobOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetCartOrderJobOptions builder
   */
