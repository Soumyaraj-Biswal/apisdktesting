...
/**
 * The getWorkspaceSettingsValue options.
 */
public class GetWorkspaceSettingsValueOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetWorkspaceSettingsValueOptions getWorkspaceSettingsValueOptions) {
      this.workspaceId = getWorkspaceSettingsValueOptions.workspaceId;
      this.varName = getWorkspaceSettingsValueOptions.varName;
      this.offset = getWorkspaceSettingsValueOptions.offset;
      this.limit = getWorkspaceSettingsValueOptions.limit;
    }
    ...
    /**
     * Builds a GetWorkspaceSettingsValueOptions.
     *
     * @return the new GetWorkspaceSettingsValueOptions instance
     */
    public GetWorkspaceSettingsValueOptions build() {
      return new GetWorkspaceSettingsValueOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the GetWorkspaceSettingsValueOptions builder
     */
  ...
  protected GetWorkspaceSettingsValueOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetWorkspaceSettingsValueOptions builder
   */
