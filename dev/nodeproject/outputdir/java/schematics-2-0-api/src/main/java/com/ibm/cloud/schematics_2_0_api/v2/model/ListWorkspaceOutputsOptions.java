...
/**
 * The listWorkspaceOutputs options.
 */
public class ListWorkspaceOutputsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListWorkspaceOutputsOptions listWorkspaceOutputsOptions) {
      this.workspaceId = listWorkspaceOutputsOptions.workspaceId;
      this.offset = listWorkspaceOutputsOptions.offset;
      this.limit = listWorkspaceOutputsOptions.limit;
    }
    ...
    /**
     * Builds a ListWorkspaceOutputsOptions.
     *
     * @return the new ListWorkspaceOutputsOptions instance
     */
    public ListWorkspaceOutputsOptions build() {
      return new ListWorkspaceOutputsOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the ListWorkspaceOutputsOptions builder
     */
  ...
  protected ListWorkspaceOutputsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListWorkspaceOutputsOptions builder
   */
