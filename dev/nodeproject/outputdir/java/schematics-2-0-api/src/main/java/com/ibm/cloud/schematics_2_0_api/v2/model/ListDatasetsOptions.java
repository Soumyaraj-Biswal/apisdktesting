...
/**
 * The listDatasets options.
 */
public class ListDatasetsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListDatasetsOptions listDatasetsOptions) {
      this.offset = listDatasetsOptions.offset;
      this.limit = listDatasetsOptions.limit;
      this.sort = listDatasetsOptions.sort;
      this.profile = listDatasetsOptions.profile;
    }
    ...
    /**
     * Builds a ListDatasetsOptions.
     *
     * @return the new ListDatasetsOptions instance
     */
    public ListDatasetsOptions build() {
      return new ListDatasetsOptions(this);
    }
     ...
     * @return the ListDatasetsOptions builder
     */
  ...
  protected ListDatasetsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListDatasetsOptions builder
   */
