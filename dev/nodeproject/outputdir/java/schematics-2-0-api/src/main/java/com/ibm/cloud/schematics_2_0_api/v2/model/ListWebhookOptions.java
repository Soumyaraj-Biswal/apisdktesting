...
/**
 * The listWebhook options.
 */
public class ListWebhookOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListWebhookOptions listWebhookOptions) {
      this.offset = listWebhookOptions.offset;
      this.limit = listWebhookOptions.limit;
      this.sort = listWebhookOptions.sort;
    }
    ...
    /**
     * Builds a ListWebhookOptions.
     *
     * @return the new ListWebhookOptions instance
     */
    public ListWebhookOptions build() {
      return new ListWebhookOptions(this);
    }
     ...
     * @return the ListWebhookOptions builder
     */
  ...
  protected ListWebhookOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListWebhookOptions builder
   */
