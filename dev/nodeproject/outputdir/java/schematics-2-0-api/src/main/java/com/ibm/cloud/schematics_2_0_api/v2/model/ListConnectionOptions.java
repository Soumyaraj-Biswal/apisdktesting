...
/**
 * The listConnection options.
 */
public class ListConnectionOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListConnectionOptions listConnectionOptions) {
      this.offset = listConnectionOptions.offset;
      this.limit = listConnectionOptions.limit;
      this.sort = listConnectionOptions.sort;
    }
    ...
    /**
     * Builds a ListConnectionOptions.
     *
     * @return the new ListConnectionOptions instance
     */
    public ListConnectionOptions build() {
      return new ListConnectionOptions(this);
    }
     ...
     * @return the ListConnectionOptions builder
     */
  ...
  protected ListConnectionOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListConnectionOptions builder
   */
