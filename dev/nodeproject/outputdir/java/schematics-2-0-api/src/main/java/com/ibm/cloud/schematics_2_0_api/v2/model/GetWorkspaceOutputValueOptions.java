...
/**
 * The getWorkspaceOutputValue options.
 */
public class GetWorkspaceOutputValueOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetWorkspaceOutputValueOptions getWorkspaceOutputValueOptions) {
      this.workspaceId = getWorkspaceOutputValueOptions.workspaceId;
      this.varName = getWorkspaceOutputValueOptions.varName;
      this.offset = getWorkspaceOutputValueOptions.offset;
      this.limit = getWorkspaceOutputValueOptions.limit;
    }
    ...
    /**
     * Builds a GetWorkspaceOutputValueOptions.
     *
     * @return the new GetWorkspaceOutputValueOptions instance
     */
    public GetWorkspaceOutputValueOptions build() {
      return new GetWorkspaceOutputValueOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the GetWorkspaceOutputValueOptions builder
     */
  ...
  protected GetWorkspaceOutputValueOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetWorkspaceOutputValueOptions builder
   */
