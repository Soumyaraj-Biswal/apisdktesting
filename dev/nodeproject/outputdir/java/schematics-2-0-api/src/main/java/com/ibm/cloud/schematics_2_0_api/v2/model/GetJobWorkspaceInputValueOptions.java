...
/**
 * The getJobWorkspaceInputValue options.
 */
public class GetJobWorkspaceInputValueOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(GetJobWorkspaceInputValueOptions getJobWorkspaceInputValueOptions) {
      this.jobId = getJobWorkspaceInputValueOptions.jobId;
      this.workspaceId = getJobWorkspaceInputValueOptions.workspaceId;
      this.varName = getJobWorkspaceInputValueOptions.varName;
      this.offset = getJobWorkspaceInputValueOptions.offset;
      this.limit = getJobWorkspaceInputValueOptions.limit;
    }
    ...
    /**
     * Builds a GetJobWorkspaceInputValueOptions.
     *
     * @return the new GetJobWorkspaceInputValueOptions instance
     */
    public GetJobWorkspaceInputValueOptions build() {
      return new GetJobWorkspaceInputValueOptions(this);
    }
     ...
     *
     * @param jobId the jobId
     * @return the GetJobWorkspaceInputValueOptions builder
     */
  ...
  protected GetJobWorkspaceInputValueOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a GetJobWorkspaceInputValueOptions builder
   */
