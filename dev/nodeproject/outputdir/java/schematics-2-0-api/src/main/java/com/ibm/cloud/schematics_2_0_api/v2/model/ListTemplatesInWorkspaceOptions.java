...
/**
 * The listTemplatesInWorkspace options.
 */
public class ListTemplatesInWorkspaceOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListTemplatesInWorkspaceOptions listTemplatesInWorkspaceOptions) {
      this.workspaceId = listTemplatesInWorkspaceOptions.workspaceId;
      this.offset = listTemplatesInWorkspaceOptions.offset;
      this.limit = listTemplatesInWorkspaceOptions.limit;
      this.sort = listTemplatesInWorkspaceOptions.sort;
      this.profile = listTemplatesInWorkspaceOptions.profile;
    }
    ...
    /**
     * Builds a ListTemplatesInWorkspaceOptions.
     *
     * @return the new ListTemplatesInWorkspaceOptions instance
     */
    public ListTemplatesInWorkspaceOptions build() {
      return new ListTemplatesInWorkspaceOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the ListTemplatesInWorkspaceOptions builder
     */
  ...
  protected ListTemplatesInWorkspaceOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListTemplatesInWorkspaceOptions builder
   */
