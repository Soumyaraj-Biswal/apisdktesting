...
/**
 * The replaceFlowInWorkspace options.
 */
public class ReplaceFlowInWorkspaceOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ReplaceFlowInWorkspaceOptions replaceFlowInWorkspaceOptions) {
      this.workspaceId = replaceFlowInWorkspaceOptions.workspaceId;
      this.flowId = replaceFlowInWorkspaceOptions.flowId;
      this.templateFlow = replaceFlowInWorkspaceOptions.templateFlow;
    }
    ...
    /**
     * Builds a ReplaceFlowInWorkspaceOptions.
     *
     * @return the new ReplaceFlowInWorkspaceOptions instance
     */
    public ReplaceFlowInWorkspaceOptions build() {
      return new ReplaceFlowInWorkspaceOptions(this);
    }
     ...
     *
     * @param workspaceId the workspaceId
     * @return the ReplaceFlowInWorkspaceOptions builder
     */
  ...
  protected ReplaceFlowInWorkspaceOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ReplaceFlowInWorkspaceOptions builder
   */
