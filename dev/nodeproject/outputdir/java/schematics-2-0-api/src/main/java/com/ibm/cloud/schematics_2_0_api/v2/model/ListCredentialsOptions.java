...
public class ListCredentialsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListCredentialsOptions listCredentialsOptions) {
      this.offset = listCredentialsOptions.offset;
      this.limit = listCredentialsOptions.limit;
      this.sort = listCredentialsOptions.sort;
      this.profile = listCredentialsOptions.profile;
    }
