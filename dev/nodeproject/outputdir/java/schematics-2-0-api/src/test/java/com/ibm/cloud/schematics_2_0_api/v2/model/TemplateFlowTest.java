...
/**
 * Unit test class for the TemplateFlow model.
 */
public class TemplateFlowTest {
  ...
  @Test
  public void testTemplateFlow() throws Throwable {
    ...
    String json = TestUtilities.serialize(templateFlowModel);

    TemplateFlow templateFlowModelNew = TestUtilities.deserialize(json, TemplateFlow.class);
    assertTrue(templateFlowModelNew instanceof TemplateFlow);
    assertEquals(templateFlowModelNew.getName(), "testString");
    assertEquals(templateFlowModelNew.getVersion(), "testString");
    assertEquals(templateFlowModelNew.getType(), "simple_flow");
    assertEquals(templateFlowModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(templateFlowModelNew.getDefinition().toString(), templateFlowDefinitionModel.toString());
    assertEquals(templateFlowModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(templateFlowModelNew.getStatus().toString(), jobStatusWorkspaceTemplateFlowModel.toString());
    assertEquals(templateFlowModelNew.getValidationSummary().toString(), templateFlowValidationSummaryModel.toString());
    assertEquals(templateFlowModelNew.get("foo"), "testString");
  }
}