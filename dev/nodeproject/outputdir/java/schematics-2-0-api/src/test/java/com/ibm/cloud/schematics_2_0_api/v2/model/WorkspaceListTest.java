...
/**
 * Unit test class for the WorkspaceList model.
 */
public class WorkspaceListTest {
  ...
  @Test
  public void testWorkspaceList() throws Throwable {
    WorkspaceList workspaceListModel = new WorkspaceList();
    assertNull(workspaceListModel.getOffset());
    assertNull(workspaceListModel.getWorkspaces());
  }
}