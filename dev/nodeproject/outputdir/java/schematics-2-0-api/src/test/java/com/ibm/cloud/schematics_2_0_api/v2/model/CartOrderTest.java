...
public class CartOrderTest {
  ...
  public void testCartOrder() throws Throwable {
    ...
    assertEquals(cartOrderModelNew.getName(), "MySatelliteLocation");
    assertEquals(cartOrderModelNew.getDescription(), "Creates satellite location in AWS");
    assertEquals(cartOrderModelNew.getServiceName(), "SatelliteLocation");
    assertEquals(cartOrderModelNew.getResourceGroup(), "testString");
    assertEquals(cartOrderModelNew.getLocation(), "us-south");
    assertEquals(cartOrderModelNew.getUserState().toString(), cartOrderUserStateModel.toString());
    assertEquals(cartOrderModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(cartOrderModelNew.getState().toString(), cartOrderLiteStateModel.toString());
    assertEquals(cartOrderModelNew.get("foo"), "testString");
  }
