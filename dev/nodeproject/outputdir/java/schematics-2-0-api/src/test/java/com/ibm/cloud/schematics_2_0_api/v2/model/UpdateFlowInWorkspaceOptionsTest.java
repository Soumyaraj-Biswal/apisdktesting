...
/**
 * Unit test class for the UpdateFlowInWorkspaceOptions model.
 */
public class UpdateFlowInWorkspaceOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateFlowInWorkspaceOptions() throws Throwable {
    ...
    UpdateFlowInWorkspaceOptions updateFlowInWorkspaceOptionsModel = new UpdateFlowInWorkspaceOptions.Builder()
      ...
      .build();
    assertEquals(updateFlowInWorkspaceOptionsModel.workspaceId(), "testString");
    assertEquals(updateFlowInWorkspaceOptionsModel.flowId(), "testString");
    assertEquals(updateFlowInWorkspaceOptionsModel.templateFlow(), templateFlowModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateFlowInWorkspaceOptionsError() throws Throwable {
    new UpdateFlowInWorkspaceOptions.Builder().build();
  }
