...
/**
 * Unit test class for the CreateConnectionOptions model.
 */
public class CreateConnectionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateConnectionOptions() throws Throwable {
    ...
    CreateConnectionOptions createConnectionOptionsModel = new CreateConnectionOptions.Builder()
      ...
      .build();
    assertEquals(createConnectionOptionsModel.connection(), connectionModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateConnectionOptionsError() throws Throwable {
    new CreateConnectionOptions.Builder().build();
  }
