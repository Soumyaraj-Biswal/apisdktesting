...
public class JobDataFlowTest {
  ...
  public void testJobDataFlow() throws Throwable {
    ...
    assertEquals(jobDataFlowModelNew.getFlowId(), "testString");
    assertEquals(jobDataFlowModelNew.getFlowName(), "testString");
    assertEquals(jobDataFlowModelNew.getUpdatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(jobDataFlowModelNew.get("foo"), "testString");
  }
}