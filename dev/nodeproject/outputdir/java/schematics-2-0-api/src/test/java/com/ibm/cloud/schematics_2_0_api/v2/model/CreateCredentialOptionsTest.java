...
/**
 * Unit test class for the CreateCredentialOptions model.
 */
public class CreateCredentialOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateCredentialOptions() throws Throwable {
    ...
    CreateCredentialOptions createCredentialOptionsModel = new CreateCredentialOptions.Builder()
      ...
      .build();
    assertEquals(createCredentialOptionsModel.credentialset(), credentialsetModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateCredentialOptionsError() throws Throwable {
    new CreateCredentialOptions.Builder().build();
  }
