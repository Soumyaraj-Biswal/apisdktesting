...
/**
 * Unit test class for the Capsule model.
 */
public class CapsuleTest {
  ...
  @Test
  public void testCapsule() throws Throwable {
    ...
    String json = TestUtilities.serialize(capsuleModel);

    Capsule capsuleModelNew = TestUtilities.deserialize(json, Capsule.class);
    assertTrue(capsuleModelNew instanceof Capsule);
    assertEquals(capsuleModelNew.getName(), "testString");
    assertEquals(capsuleModelNew.getDescription(), "testString");
    assertEquals(capsuleModelNew.getType(), "testString");
    assertEquals(capsuleModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(capsuleModelNew.getXPackage(), "Policy package path");
    assertEquals(capsuleModelNew.getSeverity(), Long.valueOf("1"));
    assertEquals(capsuleModelNew.getInventory(), "testString");
    assertEquals(capsuleModelNew.getTriggerRecordId(), "testString");
    assertEquals(capsuleModelNew.getId(), "testString");
    assertEquals(capsuleModelNew.getStatus(), "testString");
    assertEquals(capsuleModelNew.getControlsId(), "testString");
    assertEquals(capsuleModelNew.getControlsName(), "testString");
    assertEquals(capsuleModelNew.getCreatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(capsuleModelNew.getCreatedBy(), "testString");
    assertEquals(capsuleModelNew.getUpdatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(capsuleModelNew.getUpdatedBy(), "testString");
    assertEquals(capsuleModelNew.getState().toString(), controlsLiteStateModel.toString());
    assertEquals(capsuleModelNew.getLastJobData().toString(), jobDataCapsuleModel.toString());
    assertEquals(capsuleModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(capsuleModelNew.get("foo"), "testString");
  }
}