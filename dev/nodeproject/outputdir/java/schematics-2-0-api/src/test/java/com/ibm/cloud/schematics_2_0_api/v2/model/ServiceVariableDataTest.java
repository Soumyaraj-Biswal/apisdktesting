...
public class ServiceVariableDataTest {
  ...
  public void testServiceVariableData() throws Throwable {
    ...
    assertEquals(serviceVariableDataModelNew.getName(), "testString");
    assertEquals(serviceVariableDataModelNew.getValue(), "testString");
    assertEquals(serviceVariableDataModelNew.getMetadata().toString(), variableMetadataModel.toString());
    assertEquals(serviceVariableDataModelNew.get("foo"), "testString");
  }
}