...
/**
 * Unit test class for the UpdateAtasetOptions model.
 */
public class UpdateAtasetOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateAtasetOptions() throws Throwable {
    ...
    UpdateAtasetOptions updateAtasetOptionsModel = new UpdateAtasetOptions.Builder()
      ...
      .build();
    assertEquals(updateAtasetOptionsModel.datasetId(), "testString");
    assertEquals(updateAtasetOptionsModel.dataset(), datasetModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateAtasetOptionsError() throws Throwable {
    new UpdateAtasetOptions.Builder().build();
  }
