...
public class TriggerTest {
  ...
  public void testTrigger() throws Throwable {
    ...
    Trigger triggerModel = new Trigger.Builder()
      ...
      .add("foo", "testString")
      .build();
    assertEquals(triggerModel.getName(), "testString");
    assertEquals(triggerModel.getType(), "action");
    assertEquals(triggerModel.getDescription(), "testString");
    assertEquals(triggerModel.getResourceGroup(), "testString");
    assertEquals(triggerModel.getServiceId(), TestUtilities.createMockByteArray("This is a mock byte array value."));
    assertEquals(triggerModel.getApikey(), TestUtilities.createMockByteArray("This is a mock byte array value."));
    assertEquals(triggerModel.getLocation(), "us-south");
    assertEquals(triggerModel.getTags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(triggerModel.getJobTriggers(), new java.util.ArrayList<TriggerJob>(java.util.Arrays.asList(triggerJobModel)));
    assertEquals(triggerModel.getScheduledTriggers(), new java.util.ArrayList<TriggerScheduled>(java.util.Arrays.asList(triggerScheduledModel)));
    assertEquals(triggerModel.getUserState(), userStateModel);
    assertEquals(triggerModel.getSysLock(), systemLockModel);
    assertEquals(triggerModel.get("foo"), "testString");

    String json = TestUtilities.serialize(triggerModel);

    Trigger triggerModelNew = TestUtilities.deserialize(json, Trigger.class);
    assertTrue(triggerModelNew instanceof Trigger);
    assertEquals(triggerModelNew.getName(), "testString");
    assertEquals(triggerModelNew.getType(), "action");
    assertEquals(triggerModelNew.getDescription(), "testString");
    assertEquals(triggerModelNew.getResourceGroup(), "testString");
    assertEquals(triggerModelNew.getServiceId(), TestUtilities.createMockByteArray("This is a mock byte array value."));
    assertEquals(triggerModelNew.getApikey(), TestUtilities.createMockByteArray("This is a mock byte array value."));
    assertEquals(triggerModelNew.getLocation(), "us-south");
    assertEquals(triggerModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(triggerModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(triggerModelNew.get("foo"), "testString");
  }
}