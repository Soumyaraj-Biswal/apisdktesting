...
/**
 * Unit test class for the UpdateCapsuleOptions model.
 */
public class UpdateCapsuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCapsuleOptions() throws Throwable {
    ...
    UpdateCapsuleOptions updateCapsuleOptionsModel = new UpdateCapsuleOptions.Builder()
      ...
      .build();
    assertEquals(updateCapsuleOptionsModel.controlsId(), "testString");
    assertEquals(updateCapsuleOptionsModel.capsuleId(), "testString");
    assertEquals(updateCapsuleOptionsModel.capsule(), capsuleModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateCapsuleOptionsError() throws Throwable {
    new UpdateCapsuleOptions.Builder().build();
  }
