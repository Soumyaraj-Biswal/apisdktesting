...
public class OrderItemConfigurationTest {
  ...
  public void testOrderItemConfiguration() throws Throwable {
    ...
    assertEquals(orderItemConfigurationModelNew.getName(), "AWS Satellite");
    assertEquals(orderItemConfigurationModelNew.getDescription(), "Create satellite location in AWS");
    assertEquals(orderItemConfigurationModelNew.getTarget().toString(), targetRequestModel.toString());
    assertEquals(orderItemConfigurationModelNew.getOperation(), "install");
    assertEquals(orderItemConfigurationModelNew.getCatalogId(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingId(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOwningAccount(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOwningAccountCrn(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingKindId(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingTargetKind(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingVersionId(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingKind(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingFulfilmentKind(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingVersion(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingProvisionerUrl(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingProvisionerSsh(), "testString");
    assertEquals(orderItemConfigurationModelNew.getOfferingProvisionerWorkingDirectory(), "testString");
    assertEquals(orderItemConfigurationModelNew.getItemSku().toString(), itemSkuModel.toString());
    assertEquals(orderItemConfigurationModelNew.get("foo"), "testString");
  }
