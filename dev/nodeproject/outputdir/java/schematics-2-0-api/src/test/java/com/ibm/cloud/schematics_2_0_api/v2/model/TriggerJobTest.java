...
/**
 * Unit test class for the TriggerJob model.
 */
public class TriggerJobTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testTriggerJob() throws Throwable {
    ...
    String json = TestUtilities.serialize(triggerJobModel);

    TriggerJob triggerJobModelNew = TestUtilities.deserialize(json, TriggerJob.class);
    assertTrue(triggerJobModelNew instanceof TriggerJob);
    assertEquals(triggerJobModelNew.getEvent(), "before | after");
    assertEquals(triggerJobModelNew.getJob().toString(), jobModel.toString());
    assertEquals(triggerJobModelNew.get("foo"), "testString");
  }
}