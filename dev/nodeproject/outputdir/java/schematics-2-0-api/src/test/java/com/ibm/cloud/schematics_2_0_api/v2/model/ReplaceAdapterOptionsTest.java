...
/**
 * Unit test class for the ReplaceAdapterOptions model.
 */
public class ReplaceAdapterOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceAdapterOptions() throws Throwable {
    ...
    ReplaceAdapterOptions replaceAdapterOptionsModel = new ReplaceAdapterOptions.Builder()
      ...
      .build();
    assertEquals(replaceAdapterOptionsModel.adapterId(), "testString");
    assertEquals(replaceAdapterOptionsModel.adapter(), adapterModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceAdapterOptionsError() throws Throwable {
    new ReplaceAdapterOptions.Builder().build();
  }
