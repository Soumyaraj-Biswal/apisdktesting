...
/**
 * Unit test class for the Dataset model.
 */
public class DatasetTest {
  ...
  public void testDataset() throws Throwable {
    ...
    String json = TestUtilities.serialize(datasetModel);

    Dataset datasetModelNew = TestUtilities.deserialize(json, Dataset.class);
    assertTrue(datasetModelNew instanceof Dataset);
    assertEquals(datasetModelNew.getName(), "testString");
    assertEquals(datasetModelNew.getType(), "credential");
    assertEquals(datasetModelNew.getDescription(), "testString");
    assertEquals(datasetModelNew.getResourceGroup(), "testString");
    assertEquals(datasetModelNew.getLocation(), "us-south");
    assertEquals(datasetModelNew.getSource().toString(), externalSourceModel.toString());
    assertEquals(datasetModelNew.getSourceType(), "local");
    assertEquals(datasetModelNew.getSourceLink(), "static");
    assertEquals(datasetModelNew.getSourceReadmeUrl(), "testString");
    assertEquals(datasetModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(datasetModelNew.isAutoPropagateChange(), Boolean.valueOf(true));
    assertEquals(datasetModelNew.get("foo"), "testString");
  }
}