...
/**
 * Unit test class for the CreateWebhookOptions model.
 */
public class CreateWebhookOptionsTest {
  ...
  @Test
  public void testCreateWebhookOptions() throws Throwable {
    ...
    CreateWebhookOptions createWebhookOptionsModel = new CreateWebhookOptions.Builder()
      ...
      .build();
    assertEquals(createWebhookOptionsModel.webHook(), webHookModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateWebhookOptionsError() throws Throwable {
    new CreateWebhookOptions.Builder().build();
  }
