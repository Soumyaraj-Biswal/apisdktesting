...
public class JobStatusFlowTest {
  ...
  public void testJobStatusFlow() throws Throwable {
    ...
    assertEquals(jobStatusFlowModelNew.getFlowId(), "testString");
    assertEquals(jobStatusFlowModelNew.getFlowName(), "testString");
    assertEquals(jobStatusFlowModelNew.getStatusCode(), "job_pending");
    assertEquals(jobStatusFlowModelNew.getStatusMessage(), "testString");
    assertEquals(jobStatusFlowModelNew.getUpdatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(jobStatusFlowModelNew.get("foo"), "testString");
  }
}