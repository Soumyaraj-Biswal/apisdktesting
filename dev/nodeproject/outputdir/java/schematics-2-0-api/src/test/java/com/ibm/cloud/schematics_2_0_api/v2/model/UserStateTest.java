...
public class UserStateTest {
  ...
  public void testUserState() throws Throwable {
    ...
    assertEquals(userStateModelNew.getState(), "draft");
    assertEquals(userStateModelNew.getSetBy(), "testString");
    assertEquals(userStateModelNew.getSetAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(userStateModelNew.get("foo"), "testString");
  }
}