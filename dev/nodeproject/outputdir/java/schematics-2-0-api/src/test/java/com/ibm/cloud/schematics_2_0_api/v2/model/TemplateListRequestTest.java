...
/**
 * Unit test class for the TemplateListRequest model.
 */
public class TemplateListRequestTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testTemplateListRequest() throws Throwable {
    ...
    String json = TestUtilities.serialize(templateListRequestModel);

    TemplateListRequest templateListRequestModelNew = TestUtilities.deserialize(json, TemplateListRequest.class);
    assertTrue(templateListRequestModelNew instanceof TemplateListRequest);
    assertEquals(templateListRequestModelNew.get("foo"), "testString");
  }
}