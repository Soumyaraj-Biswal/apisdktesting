...
/**
 * Unit test class for the CreateCapsuleOptions model.
 */
public class CreateCapsuleOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateCapsuleOptions() throws Throwable {
    ...
    CreateCapsuleOptions createCapsuleOptionsModel = new CreateCapsuleOptions.Builder()
      ...
      .build();
    assertEquals(createCapsuleOptionsModel.controlsId(), "testString");
    assertEquals(createCapsuleOptionsModel.capsule(), capsuleModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateCapsuleOptionsError() throws Throwable {
    new CreateCapsuleOptions.Builder().build();
  }
