...
/**
 * Unit test class for the CreatePrivateClusterOptions model.
 */
public class CreatePrivateClusterOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreatePrivateClusterOptions() throws Throwable {
    ...
    CreatePrivateClusterOptions createPrivateClusterOptionsModel = new CreatePrivateClusterOptions.Builder()
      ...
      .build();
    assertEquals(createPrivateClusterOptionsModel.privateCluster(), privateClusterModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreatePrivateClusterOptionsError() throws Throwable {
    new CreatePrivateClusterOptions.Builder().build();
  }
