...
/**
 * Unit test class for the UpdateTemplateInWorkspaceOptions model.
 */
public class UpdateTemplateInWorkspaceOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateTemplateInWorkspaceOptions() throws Throwable {
    ...
    UpdateTemplateInWorkspaceOptions updateTemplateInWorkspaceOptionsModel = new UpdateTemplateInWorkspaceOptions.Builder()
      ...
      .build();
    assertEquals(updateTemplateInWorkspaceOptionsModel.workspaceId(), "testString");
    assertEquals(updateTemplateInWorkspaceOptionsModel.templateId(), "testString");
    assertEquals(updateTemplateInWorkspaceOptionsModel.template(), templateModel);
    assertEquals(updateTemplateInWorkspaceOptionsModel.xGithubToken(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateTemplateInWorkspaceOptionsError() throws Throwable {
    new UpdateTemplateInWorkspaceOptions.Builder().build();
  }
