...
/**
 * Unit test class for the UpdateCartOrder model.
 */
public class UpdateCartOrderTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCartOrder() throws Throwable {
    ...
    String json = TestUtilities.serialize(updateCartOrderModel);

    UpdateCartOrder updateCartOrderModelNew = TestUtilities.deserialize(json, UpdateCartOrder.class);
    assertTrue(updateCartOrderModelNew instanceof UpdateCartOrder);
    assertEquals(updateCartOrderModelNew.getName(), "MySatelliteLocation");
    assertEquals(updateCartOrderModelNew.getDescription(), "Creates satellite location in AWS");
    assertEquals(updateCartOrderModelNew.get("foo"), "testString");
  }
}