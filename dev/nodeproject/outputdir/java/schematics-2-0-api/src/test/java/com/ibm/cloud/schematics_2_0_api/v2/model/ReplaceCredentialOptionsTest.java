...
/**
 * Unit test class for the ReplaceCredentialOptions model.
 */
public class ReplaceCredentialOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceCredentialOptions() throws Throwable {
    ...
    ReplaceCredentialOptions replaceCredentialOptionsModel = new ReplaceCredentialOptions.Builder()
      ...
      .build();
    assertEquals(replaceCredentialOptionsModel.credsId(), "testString");
    assertEquals(replaceCredentialOptionsModel.credentialset(), credentialsetModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceCredentialOptionsError() throws Throwable {
    new ReplaceCredentialOptions.Builder().build();
  }
