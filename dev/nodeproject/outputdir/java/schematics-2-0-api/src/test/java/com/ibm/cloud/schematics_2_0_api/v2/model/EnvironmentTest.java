...
public class EnvironmentTest {
  ...
  public void testEnvironment() throws Throwable {
    ...
    assertEquals(environmentModelNew.getName(), "Toronto Dev Environtment");
    assertEquals(environmentModelNew.getSchemaVersion(), "1.0");
    assertEquals(environmentModelNew.getSource().toString(), externalSourceModel.toString());
    assertEquals(environmentModelNew.getDescription(), "Deploys dev environtment instance in Toronto Region");
    assertEquals(environmentModelNew.getResourceGroup(), "Default");
    assertEquals(environmentModelNew.getLocation(), "us-south");
    assertEquals(environmentModelNew.getBlueprint().toString(), blueprintModel.toString());
    assertEquals(environmentModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(environmentModelNew.getUserState().toString(), environmentUserStateModel.toString());
    assertEquals(environmentModelNew.getState().toString(), environmentStateModel.toString());
    assertEquals(environmentModelNew.get("foo"), "testString");
  }
