...
public class WorkspaceTest {
  ...
  public void testWorkspace() throws Throwable {
    ...
    String json = TestUtilities.serialize(workspaceModel);

    Workspace workspaceModelNew = TestUtilities.deserialize(json, Workspace.class);
    assertTrue(workspaceModelNew instanceof Workspace);
    assertEquals(workspaceModelNew.getName(), "My Workspace");
    assertEquals(workspaceModelNew.getDescription(), "This workspace manages front-end micro service for production environment");
    assertEquals(workspaceModelNew.getResourceGroup(), "testString");
    assertEquals(workspaceModelNew.isDestroyResourcesOnDelete(), Boolean.valueOf(true));
    assertEquals(workspaceModelNew.getLocation(), "us-south");
    assertEquals(workspaceModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(workspaceModelNew.getCommandParameter(), "testString");
    assertEquals(workspaceModelNew.getState().toString(), workspaceLiteStateModel.toString());
    assertEquals(workspaceModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(workspaceModelNew.get("foo"), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testWorkspaceError() throws Throwable {
    new Workspace.Builder().build();
  }
