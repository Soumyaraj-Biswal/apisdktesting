...
public class ActionTest {
  ...
  public void testAction() throws Throwable {
    ...
    assertEquals(actionModelNew.getName(), "Stop Action");
    assertEquals(actionModelNew.getDescription(), "The description of your action. The description can be up to 2048 characters long in size. **Example** you can use the description to stop the targets.");
    assertEquals(actionModelNew.getLocation(), "us-south");
    assertEquals(actionModelNew.getResourceGroup(), "testString");
    assertEquals(actionModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(actionModelNew.getSourceReadmeUrl(), "testString");
    assertEquals(actionModelNew.getSource().toString(), externalSourceModel.toString());
    assertEquals(actionModelNew.getSourceType(), "local");
    assertEquals(actionModelNew.getCommandParameter(), "testString");
    assertEquals(actionModelNew.getInventory(), "testString");
    assertEquals(actionModelNew.getBastion().toString(), bastionResourceDefinitionModel.toString());
    assertEquals(actionModelNew.getBastionCredential().toString(), variableDataModel.toString());
    assertEquals(actionModelNew.getTargetsIni(), "testString");
    assertEquals(actionModelNew.getState().toString(), actionStateModel.toString());
    assertEquals(actionModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(actionModelNew.get("foo"), "testString");
  }
}