...
/**
 * Unit test class for the Controls model.
 */
public class ControlsTest {
  ...
  @Test
  public void testControls() throws Throwable {
    ...
    String json = TestUtilities.serialize(controlsModel);

    Controls controlsModelNew = TestUtilities.deserialize(json, Controls.class);
    assertTrue(controlsModelNew instanceof Controls);
    assertEquals(controlsModelNew.getName(), "testString");
    assertEquals(controlsModelNew.getType(), "it_controls");
    assertEquals(controlsModelNew.getDescription(), "testString");
    assertEquals(controlsModelNew.getResourceGroup(), "testString");
    assertEquals(controlsModelNew.getLocation(), "us-south");
    assertEquals(controlsModelNew.getSourceReadmeUrl(), "testString");
    assertEquals(controlsModelNew.getSource().toString(), externalSourceModel.toString());
    assertEquals(controlsModelNew.getSourceType(), "local");
    assertEquals(controlsModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(controlsModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(controlsModelNew.get("foo"), "testString");
  }
}