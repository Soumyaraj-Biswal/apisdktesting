...
/**
 * Unit test class for the ResourceQueryDefinition model.
 */
public class ResourceQueryDefinitionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testResourceQueryDefinition() throws Throwable {
    ...
    String json = TestUtilities.serialize(resourceQueryDefinitionModel);

    ResourceQueryDefinition resourceQueryDefinitionModelNew = TestUtilities.deserialize(json, ResourceQueryDefinition.class);
    assertTrue(resourceQueryDefinitionModelNew instanceof ResourceQueryDefinition);
    assertEquals(resourceQueryDefinitionModelNew.getType(), "vsi");
    assertEquals(resourceQueryDefinitionModelNew.getName(), "testString");
    assertEquals(resourceQueryDefinitionModelNew.get("foo"), "testString");
  }
}