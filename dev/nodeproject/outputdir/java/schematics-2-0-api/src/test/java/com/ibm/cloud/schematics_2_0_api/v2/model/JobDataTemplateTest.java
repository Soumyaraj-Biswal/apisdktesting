...
public class JobDataTemplateTest {
  ...
  public void testJobDataTemplate() throws Throwable {
    ...
    assertEquals(jobDataTemplateModelNew.getTemplateId(), "testString");
    assertEquals(jobDataTemplateModelNew.getTemplateName(), "testString");
    assertEquals(jobDataTemplateModelNew.getFlowIndex(), Long.valueOf("26"));
    assertEquals(jobDataTemplateModelNew.getUpdatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(jobDataTemplateModelNew.get("foo"), "testString");
  }
}