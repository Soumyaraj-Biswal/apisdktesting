...
public class TemplateTest {
  ...
  public void testTemplate() throws Throwable {
    ...
    String json = TestUtilities.serialize(templateModel);

    Template templateModelNew = TestUtilities.deserialize(json, Template.class);
    assertTrue(templateModelNew instanceof Template);
    assertEquals(templateModelNew.getName(), "vpc_terraform / helm_front_end_app_micro_service");
    assertEquals(templateModelNew.getDescription(), "This template provisions clusters in production environment");
    assertEquals(templateModelNew.getType(), "testString");
    assertEquals(templateModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(templateModelNew.getSourceType(), "local");
    assertEquals(templateModelNew.getSource().toString(), externalSourceModel.toString());
    assertEquals(templateModelNew.getSourceReadmeUrl(), "testString");
    assertEquals(templateModelNew.getInventory(), "testString");
    assertEquals(templateModelNew.getStatus().toString(), jobStatusTemplateModel.toString());
    assertEquals(templateModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(templateModelNew.get("foo"), "testString");
  }
}