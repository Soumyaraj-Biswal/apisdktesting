...
/**
 * Unit test class for the CreateDatasetOptions model.
 */
public class CreateDatasetOptionsTest {
  ...
  @Test
  public void testCreateDatasetOptions() throws Throwable {
    ...
    CreateDatasetOptions createDatasetOptionsModel = new CreateDatasetOptions.Builder()
      ...
      .build();
    assertEquals(createDatasetOptionsModel.dataset(), datasetModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateDatasetOptionsError() throws Throwable {
    new CreateDatasetOptions.Builder().build();
  }
