...
/**
 * Unit test class for the ReplaceTriggerOptions model.
 */
public class ReplaceTriggerOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceTriggerOptions() throws Throwable {
    ...
    ReplaceTriggerOptions replaceTriggerOptionsModel = new ReplaceTriggerOptions.Builder()
      ...
      .build();
    assertEquals(replaceTriggerOptionsModel.triggerId(), "testString");
    assertEquals(replaceTriggerOptionsModel.trigger(), triggerModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceTriggerOptionsError() throws Throwable {
    new ReplaceTriggerOptions.Builder().build();
  }
