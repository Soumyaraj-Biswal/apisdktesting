...
public class ActionStateTest {
  ...
  public void testActionState() throws Throwable {
    ...
    assertEquals(actionStateModelNew.getStatusCode(), "normal");
    assertEquals(actionStateModelNew.getStatusJobId(), "testString");
    assertEquals(actionStateModelNew.getStatusMessage(), "testString");
    assertEquals(actionStateModelNew.get("foo"), "testString");
  }
}