...
public class KMSSettingsPrimaryCrkTest {
  ...
  public void testKMSSettingsPrimaryCrk() throws Throwable {
    ...
    assertEquals(kmsSettingsPrimaryCrkModelNew.getKmsName(), "testString");
    assertEquals(kmsSettingsPrimaryCrkModelNew.getKmsPrivateEndpoint(), "testString");
    assertEquals(kmsSettingsPrimaryCrkModelNew.getKeyCrn(), "testString");
    assertEquals(kmsSettingsPrimaryCrkModelNew.get("foo"), "testString");
  }
}