...
public class JobLogSummaryActionJobRecapTest {
  ...
  public void testJobLogSummaryActionJobRecap() throws Throwable {
    ...
    assertEquals(jobLogSummaryActionJobRecapModelNew.getOk(), Double.valueOf("72.5"));
    assertEquals(jobLogSummaryActionJobRecapModelNew.getChanged(), Double.valueOf("72.5"));
    assertEquals(jobLogSummaryActionJobRecapModelNew.getFailed(), Double.valueOf("72.5"));
    assertEquals(jobLogSummaryActionJobRecapModelNew.getSkipped(), Double.valueOf("72.5"));
    assertEquals(jobLogSummaryActionJobRecapModelNew.getUnreachable(), Double.valueOf("72.5"));
    assertEquals(jobLogSummaryActionJobRecapModelNew.get("foo"), "testString");
  }
}