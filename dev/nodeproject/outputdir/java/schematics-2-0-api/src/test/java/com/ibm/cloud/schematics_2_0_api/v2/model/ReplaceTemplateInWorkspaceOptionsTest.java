...
/**
 * Unit test class for the ReplaceTemplateInWorkspaceOptions model.
 */
public class ReplaceTemplateInWorkspaceOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceTemplateInWorkspaceOptions() throws Throwable {
    ...
    ReplaceTemplateInWorkspaceOptions replaceTemplateInWorkspaceOptionsModel = new ReplaceTemplateInWorkspaceOptions.Builder()
      ...
      .build();
    assertEquals(replaceTemplateInWorkspaceOptionsModel.workspaceId(), "testString");
    assertEquals(replaceTemplateInWorkspaceOptionsModel.templateId(), "testString");
    assertEquals(replaceTemplateInWorkspaceOptionsModel.template(), templateModel);
    assertEquals(replaceTemplateInWorkspaceOptionsModel.xGithubToken(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceTemplateInWorkspaceOptionsError() throws Throwable {
    new ReplaceTemplateInWorkspaceOptions.Builder().build();
  }
