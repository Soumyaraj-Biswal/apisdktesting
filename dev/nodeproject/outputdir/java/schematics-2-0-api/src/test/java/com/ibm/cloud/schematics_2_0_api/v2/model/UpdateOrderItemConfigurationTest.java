...
/**
 * Unit test class for the UpdateOrderItemConfiguration model.
 */
public class UpdateOrderItemConfigurationTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateOrderItemConfiguration() throws Throwable {
    ...
    String json = TestUtilities.serialize(updateOrderItemConfigurationModel);

    UpdateOrderItemConfiguration updateOrderItemConfigurationModelNew = TestUtilities.deserialize(json, UpdateOrderItemConfiguration.class);
    assertTrue(updateOrderItemConfigurationModelNew instanceof UpdateOrderItemConfiguration);
    assertEquals(updateOrderItemConfigurationModelNew.getName(), "AWS Satellite");
    assertEquals(updateOrderItemConfigurationModelNew.getDescription(), "Create satellite location in AWS");
    assertEquals(updateOrderItemConfigurationModelNew.getTarget().toString(), targetRequestModel.toString());
    assertEquals(updateOrderItemConfigurationModelNew.getOperation(), "install");
    assertEquals(updateOrderItemConfigurationModelNew.get("foo"), "testString");
  }
}