...
/**
 * Unit test class for the Credentialset model.
 */
public class CredentialsetTest {
  ...
  @Test
  public void testCredentialset() throws Throwable {
    ...
    Credentialset credentialsetModel = new Credentialset.Builder()
      ...
      .add("foo", "testString")
      .build();
    assertEquals(credentialsetModel.getName(), "testString");
    assertEquals(credentialsetModel.getDescription(), "testString");
    assertEquals(credentialsetModel.getResourceGroup(), "testString");
    assertEquals(credentialsetModel.getLocation(), "us-south");
    assertEquals(credentialsetModel.getTags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(credentialsetModel.getData(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(credentialsetModel.getSourceConnection(), "testString");
    assertEquals(credentialsetModel.getSource(), externalSourceModel);
    assertEquals(credentialsetModel.getSourceType(), "local");
    assertEquals(credentialsetModel.getSourceLink(), "static");
    assertEquals(credentialsetModel.getUserState(), userStateModel);
    assertEquals(credentialsetModel.isAutoPropagateChange(), Boolean.valueOf(true));
    assertEquals(credentialsetModel.isReplicaEnabled(), Boolean.valueOf(true));
    assertEquals(credentialsetModel.getReplicaInvalidationFrequency(), "hourly");
    assertEquals(credentialsetModel.get("foo"), "testString");

    String json = TestUtilities.serialize(credentialsetModel);

    Credentialset credentialsetModelNew = TestUtilities.deserialize(json, Credentialset.class);
    assertTrue(credentialsetModelNew instanceof Credentialset);
    assertEquals(credentialsetModelNew.getName(), "testString");
    assertEquals(credentialsetModelNew.getDescription(), "testString");
    assertEquals(credentialsetModelNew.getResourceGroup(), "testString");
    assertEquals(credentialsetModelNew.getLocation(), "us-south");
    assertEquals(credentialsetModelNew.getSourceConnection(), "testString");
    assertEquals(credentialsetModelNew.getSource().toString(), externalSourceModel.toString());
    assertEquals(credentialsetModelNew.getSourceType(), "local");
    assertEquals(credentialsetModelNew.getSourceLink(), "static");
    assertEquals(credentialsetModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(credentialsetModelNew.isAutoPropagateChange(), Boolean.valueOf(true));
    assertEquals(credentialsetModelNew.isReplicaEnabled(), Boolean.valueOf(true));
    assertEquals(credentialsetModelNew.getReplicaInvalidationFrequency(), "hourly");
    assertEquals(credentialsetModelNew.get("foo"), "testString");
  }
}