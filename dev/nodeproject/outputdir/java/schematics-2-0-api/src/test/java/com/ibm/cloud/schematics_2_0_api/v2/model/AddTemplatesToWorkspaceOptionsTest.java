...
/**
 * Unit test class for the AddTemplatesToWorkspaceOptions model.
 */
public class AddTemplatesToWorkspaceOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAddTemplatesToWorkspaceOptions() throws Throwable {
    ...
    AddTemplatesToWorkspaceOptions addTemplatesToWorkspaceOptionsModel = new AddTemplatesToWorkspaceOptions.Builder()
      ...
      .build();
    assertEquals(addTemplatesToWorkspaceOptionsModel.workspaceId(), "testString");
    assertEquals(addTemplatesToWorkspaceOptionsModel.template(), templateModel);
    assertEquals(addTemplatesToWorkspaceOptionsModel.xGithubToken(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testAddTemplatesToWorkspaceOptionsError() throws Throwable {
    new AddTemplatesToWorkspaceOptions.Builder().build();
  }
