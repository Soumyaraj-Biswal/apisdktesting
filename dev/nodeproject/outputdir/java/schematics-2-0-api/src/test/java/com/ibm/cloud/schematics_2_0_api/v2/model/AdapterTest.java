...
/**
 * Unit test class for the Adapter model.
 */
public class AdapterTest {
  ...
  public void testAdapter() throws Throwable {
    ...
    String json = TestUtilities.serialize(adapterModel);

    Adapter adapterModelNew = TestUtilities.deserialize(json, Adapter.class);
    assertTrue(adapterModelNew instanceof Adapter);
    assertEquals(adapterModelNew.getAdapterName(), "testString");
    assertEquals(adapterModelNew.getAdapterType(), "scm_adapter");
    assertEquals(adapterModelNew.getLocation(), "us-south");
    assertEquals(adapterModelNew.getResourceGroup(), "testString");
    assertEquals(adapterModelNew.getAdapterEndpointUrl(), "testString");
    assertEquals(adapterModelNew.getServiceId(), "testString");
    assertEquals(adapterModelNew.getApikey(), "testString");
    assertEquals(adapterModelNew.getUserState().toString(), userStateModel.toString());
    assertEquals(adapterModelNew.isIgnoreInflightOperations(), Boolean.valueOf(true));
    assertEquals(adapterModelNew.getAdapterId(), "testString");
    assertEquals(adapterModelNew.getRegisteredBy(), "testString");
    assertEquals(adapterModelNew.getRegisteredAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(adapterModelNew.getUpdatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(adapterModelNew.getUpdatedBy(), "testString");
    assertEquals(adapterModelNew.getSysLock().toString(), systemLockModel.toString());
    assertEquals(adapterModelNew.getAdapterHealth(), "active");
    assertEquals(adapterModelNew.getLastHealthCheckedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(adapterModelNew.get("foo"), "testString");
  }
}