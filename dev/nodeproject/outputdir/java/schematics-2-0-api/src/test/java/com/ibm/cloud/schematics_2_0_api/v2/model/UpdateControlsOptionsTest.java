...
/**
 * Unit test class for the UpdateControlsOptions model.
 */
public class UpdateControlsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateControlsOptions() throws Throwable {
    ...
    UpdateControlsOptions updateControlsOptionsModel = new UpdateControlsOptions.Builder()
      ...
      .build();
    assertEquals(updateControlsOptionsModel.controlsId(), "testString");
    assertEquals(updateControlsOptionsModel.controls(), controlsModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateControlsOptionsError() throws Throwable {
    new UpdateControlsOptions.Builder().build();
  }
