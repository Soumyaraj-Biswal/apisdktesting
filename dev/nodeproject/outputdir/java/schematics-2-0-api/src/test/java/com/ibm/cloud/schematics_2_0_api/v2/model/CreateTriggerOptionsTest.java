...
/**
 * Unit test class for the CreateTriggerOptions model.
 */
public class CreateTriggerOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateTriggerOptions() throws Throwable {
    ...
    CreateTriggerOptions createTriggerOptionsModel = new CreateTriggerOptions.Builder()
      ...
      .build();
    assertEquals(createTriggerOptionsModel.trigger(), triggerModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateTriggerOptionsError() throws Throwable {
    new CreateTriggerOptions.Builder().build();
  }
