...
public class JobStatusTemplateTest {
  ...
  public void testJobStatusTemplate() throws Throwable {
    ...
    assertEquals(jobStatusTemplateModelNew.getTemplateId(), "testString");
    assertEquals(jobStatusTemplateModelNew.getTemplateName(), "testString");
    assertEquals(jobStatusTemplateModelNew.getFlowIndex(), Long.valueOf("26"));
    assertEquals(jobStatusTemplateModelNew.getStatusCode(), "job_pending");
    assertEquals(jobStatusTemplateModelNew.getStatusMessage(), "testString");
    assertEquals(jobStatusTemplateModelNew.getUpdatedAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(jobStatusTemplateModelNew.get("foo"), "testString");
  }
}