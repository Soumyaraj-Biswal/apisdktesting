...
/**
 * Unit test class for the ReplaceFlowInWorkspaceOptions model.
 */
public class ReplaceFlowInWorkspaceOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceFlowInWorkspaceOptions() throws Throwable {
    ...
    ReplaceFlowInWorkspaceOptions replaceFlowInWorkspaceOptionsModel = new ReplaceFlowInWorkspaceOptions.Builder()
      ...
      .build();
    assertEquals(replaceFlowInWorkspaceOptionsModel.workspaceId(), "testString");
    assertEquals(replaceFlowInWorkspaceOptionsModel.flowId(), "testString");
    assertEquals(replaceFlowInWorkspaceOptionsModel.templateFlow(), templateFlowModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceFlowInWorkspaceOptionsError() throws Throwable {
    new ReplaceFlowInWorkspaceOptions.Builder().build();
  }
