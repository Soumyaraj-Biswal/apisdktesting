...
/**
 * Unit test class for the ReplaceWebhookOptions model.
 */
public class ReplaceWebhookOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceWebhookOptions() throws Throwable {
    ...
    ReplaceWebhookOptions replaceWebhookOptionsModel = new ReplaceWebhookOptions.Builder()
      ...
      .build();
    assertEquals(replaceWebhookOptionsModel.hookId(), "testString");
    assertEquals(replaceWebhookOptionsModel.webHook(), webHookModel);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceWebhookOptionsError() throws Throwable {
    new ReplaceWebhookOptions.Builder().build();
  }
