...
/**
 * The listCartOrderJobs options.
 */
public class ListCartOrderJobsOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListCartOrderJobsOptions listCartOrderJobsOptions) {
      this.orderId = listCartOrderJobsOptions.orderId;
      this.offset = listCartOrderJobsOptions.offset;
      this.limit = listCartOrderJobsOptions.limit;
    }
    ...
    /**
     * Builds a ListCartOrderJobsOptions.
     *
     * @return the new ListCartOrderJobsOptions instance
     */
    public ListCartOrderJobsOptions build() {
      return new ListCartOrderJobsOptions(this);
    }
     ...
     *
     * @param orderId the orderId
     * @return the ListCartOrderJobsOptions builder
     */
  ...
  protected ListCartOrderJobsOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListCartOrderJobsOptions builder
   */
