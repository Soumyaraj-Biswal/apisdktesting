...
/**
 * The listEnvironmentResources options.
 */
public class ListEnvironmentResourcesOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListEnvironmentResourcesOptions listEnvironmentResourcesOptions) {
      this.environmentId = listEnvironmentResourcesOptions.environmentId;
      this.offset = listEnvironmentResourcesOptions.offset;
      this.limit = listEnvironmentResourcesOptions.limit;
    }
    ...
    /**
     * Builds a ListEnvironmentResourcesOptions.
     *
     * @return the new ListEnvironmentResourcesOptions instance
     */
    public ListEnvironmentResourcesOptions build() {
      return new ListEnvironmentResourcesOptions(this);
    }
     ...
     *
     * @param environmentId the environmentId
     * @return the ListEnvironmentResourcesOptions builder
     */
  ...
  protected ListEnvironmentResourcesOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListEnvironmentResourcesOptions builder
   */
