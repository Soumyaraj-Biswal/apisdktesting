...
public class ReplaceEnvironmentOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ReplaceEnvironmentOptions replaceEnvironmentOptions) {
      ...
      this.name = replaceEnvironmentOptions.name;
      this.schemaVersion = replaceEnvironmentOptions.schemaVersion;
      this.source = replaceEnvironmentOptions.source;
      this.description = replaceEnvironmentOptions.description;
      this.resourceGroup = replaceEnvironmentOptions.resourceGroup;
      this.tags = replaceEnvironmentOptions.tags;
      this.location = replaceEnvironmentOptions.location;
      this.blueprint = replaceEnvironmentOptions.blueprint;
      this.config = replaceEnvironmentOptions.config;
      this.inputs = replaceEnvironmentOptions.inputs;
      this.settings = replaceEnvironmentOptions.settings;
      this.outputs = replaceEnvironmentOptions.outputs;
      this.sysLock = replaceEnvironmentOptions.sysLock;
      this.userState = replaceEnvironmentOptions.userState;
      this.state = replaceEnvironmentOptions.state;
