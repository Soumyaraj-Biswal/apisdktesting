...
/**
 * The listEnvironment options.
 */
public class ListEnvironmentOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    private Builder(ListEnvironmentOptions listEnvironmentOptions) {
      this.offset = listEnvironmentOptions.offset;
      this.limit = listEnvironmentOptions.limit;
    }
    ...
    /**
     * Builds a ListEnvironmentOptions.
     *
     * @return the new ListEnvironmentOptions instance
     */
    public ListEnvironmentOptions build() {
      return new ListEnvironmentOptions(this);
    }
     ...
     * @return the ListEnvironmentOptions builder
     */
  ...
  protected ListEnvironmentOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a ListEnvironmentOptions builder
   */
