...
public class UpdateOrderItemConfigurationTest {
  ...
  public void testUpdateOrderItemConfiguration() throws Throwable {
    ...
    assertEquals(updateOrderItemConfigurationModelNew.name(), "AWS Satellite");
    assertEquals(updateOrderItemConfigurationModelNew.description(), "Create satellite location in AWS");
    assertEquals(updateOrderItemConfigurationModelNew.target().toString(), targetRequestModel.toString());
    assertEquals(updateOrderItemConfigurationModelNew.operation(), "install");
  }
}