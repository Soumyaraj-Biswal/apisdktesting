...
import com.ibm.cloud.schematics.v1.model.CartOrder;
...
/**
 * Unit test class for the CartOrder model.
 */
public class CartOrderTest {
  ...
  @Test
  public void testCartOrder() throws Throwable {
    ...
    CartOrder cartOrderModel = new CartOrder.Builder()
      ...
      .build();
    assertEquals(cartOrderModel.name(), "MySatelliteLocation");
    assertEquals(cartOrderModel.description(), "Creates satellite location in AWS");
    assertEquals(cartOrderModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(cartOrderModel.cartItems(), new java.util.ArrayList<OrderItemConfiguration>(java.util.Arrays.asList(orderItemConfigurationModel)));
    assertEquals(cartOrderModel.serviceName(), "SatelliteLocation");
    assertEquals(cartOrderModel.resourceGroup(), "testString");
    assertEquals(cartOrderModel.location(), "us-south");
    assertEquals(cartOrderModel.userState(), cartOrderUserStateModel);
    assertEquals(cartOrderModel.sysLock(), systemLockModel);
    assertEquals(cartOrderModel.state(), cartOrderLiteStateModel);

    String json = TestUtilities.serialize(cartOrderModel);

    CartOrder cartOrderModelNew = TestUtilities.deserialize(json, CartOrder.class);
    assertTrue(cartOrderModelNew instanceof CartOrder);
    assertEquals(cartOrderModelNew.name(), "MySatelliteLocation");
    assertEquals(cartOrderModelNew.description(), "Creates satellite location in AWS");
    assertEquals(cartOrderModelNew.serviceName(), "SatelliteLocation");
    assertEquals(cartOrderModelNew.resourceGroup(), "testString");
    assertEquals(cartOrderModelNew.location(), "us-south");
    assertEquals(cartOrderModelNew.userState().toString(), cartOrderUserStateModel.toString());
    assertEquals(cartOrderModelNew.sysLock().toString(), systemLockModel.toString());
    assertEquals(cartOrderModelNew.state().toString(), cartOrderLiteStateModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCartOrderError() throws Throwable {
    new CartOrder.Builder().build();
  }
