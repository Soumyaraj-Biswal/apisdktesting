...
import com.ibm.cloud.schematics.v1.model.ReplaceEnvironmentOptions;
...
/**
 * Unit test class for the ReplaceEnvironmentOptions model.
 */
public class ReplaceEnvironmentOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceEnvironmentOptions() throws Throwable {
    ...
    ReplaceEnvironmentOptions replaceEnvironmentOptionsModel = new ReplaceEnvironmentOptions.Builder()
      ...
      .profile("ids")
      .build();
    assertEquals(replaceEnvironmentOptionsModel.environmentId(), "testString");
    assertEquals(replaceEnvironmentOptionsModel.name(), "Toronto Dev Environtment");
    assertEquals(replaceEnvironmentOptionsModel.schemaVersion(), "1.0");
    assertEquals(replaceEnvironmentOptionsModel.source(), externalSourceModel);
    assertEquals(replaceEnvironmentOptionsModel.description(), "Deploys dev environtment instance in Toronto Region");
    assertEquals(replaceEnvironmentOptionsModel.resourceGroup(), "Default");
    assertEquals(replaceEnvironmentOptionsModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(replaceEnvironmentOptionsModel.location(), "us-south");
    assertEquals(replaceEnvironmentOptionsModel.blueprint(), blueprintModel);
    assertEquals(replaceEnvironmentOptionsModel.config(), new java.util.ArrayList<ConfigItem>(java.util.Arrays.asList(configItemModel)));
    assertEquals(replaceEnvironmentOptionsModel.inputs(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(replaceEnvironmentOptionsModel.settings(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(replaceEnvironmentOptionsModel.outputs(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(replaceEnvironmentOptionsModel.sysLock(), systemLockModel);
    assertEquals(replaceEnvironmentOptionsModel.userState(), environmentUserStateModel);
    assertEquals(replaceEnvironmentOptionsModel.state(), environmentStateModel);
    assertEquals(replaceEnvironmentOptionsModel.profile(), "ids");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceEnvironmentOptionsError() throws Throwable {
    new ReplaceEnvironmentOptions.Builder().build();
  }
