...
import com.ibm.cloud.schematics.v1.model.UpdateEnvironmentOptions;
...
public class UpdateEnvironmentOptionsTest {
  ...
  public void testUpdateEnvironmentOptions() throws Throwable {
    ...
    assertEquals(updateEnvironmentOptionsModel.name(), "Toronto Dev Environtment");
    assertEquals(updateEnvironmentOptionsModel.schemaVersion(), "1.0");
    assertEquals(updateEnvironmentOptionsModel.source(), externalSourceModel);
    assertEquals(updateEnvironmentOptionsModel.description(), "Deploys dev environtment instance in Toronto Region");
    assertEquals(updateEnvironmentOptionsModel.resourceGroup(), "Default");
    assertEquals(updateEnvironmentOptionsModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(updateEnvironmentOptionsModel.location(), "us-south");
    assertEquals(updateEnvironmentOptionsModel.blueprint(), blueprintModel);
    assertEquals(updateEnvironmentOptionsModel.config(), new java.util.ArrayList<ConfigItem>(java.util.Arrays.asList(configItemModel)));
    assertEquals(updateEnvironmentOptionsModel.inputs(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(updateEnvironmentOptionsModel.settings(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(updateEnvironmentOptionsModel.outputs(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(updateEnvironmentOptionsModel.sysLock(), systemLockModel);
    assertEquals(updateEnvironmentOptionsModel.userState(), environmentUserStateModel);
    assertEquals(updateEnvironmentOptionsModel.state(), environmentStateModel);
    assertEquals(updateEnvironmentOptionsModel.profile(), "ids");
  }
