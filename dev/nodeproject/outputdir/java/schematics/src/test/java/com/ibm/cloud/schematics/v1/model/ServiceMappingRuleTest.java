...
public class ServiceMappingRuleTest {
  ...
  public void testServiceMappingRule() throws Throwable {
    ...
    assertEquals(serviceMappingRuleModelNew.type(), "testString");
    assertEquals(serviceMappingRuleModelNew.inputParamName(), "testString");
    assertEquals(serviceMappingRuleModelNew.outputParamName(), "testString");
  }
}