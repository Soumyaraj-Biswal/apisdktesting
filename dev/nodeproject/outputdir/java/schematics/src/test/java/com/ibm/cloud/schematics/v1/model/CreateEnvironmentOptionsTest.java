...
import com.ibm.cloud.schematics.v1.model.CreateEnvironmentOptions;
...
public class CreateEnvironmentOptionsTest {
  ...
  public void testCreateEnvironmentOptions() throws Throwable {
    ...
    CreateEnvironmentOptions createEnvironmentOptionsModel = new CreateEnvironmentOptions.Builder()
      ...
      .build();
    assertEquals(createEnvironmentOptionsModel.name(), "Toronto Dev Environtment");
    assertEquals(createEnvironmentOptionsModel.schemaVersion(), "1.0");
    assertEquals(createEnvironmentOptionsModel.source(), externalSourceModel);
    assertEquals(createEnvironmentOptionsModel.description(), "Deploys dev environtment instance in Toronto Region");
    assertEquals(createEnvironmentOptionsModel.resourceGroup(), "Default");
    assertEquals(createEnvironmentOptionsModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(createEnvironmentOptionsModel.location(), "us-south");
    assertEquals(createEnvironmentOptionsModel.blueprint(), blueprintModel);
    assertEquals(createEnvironmentOptionsModel.config(), new java.util.ArrayList<ConfigItem>(java.util.Arrays.asList(configItemModel)));
    assertEquals(createEnvironmentOptionsModel.inputs(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(createEnvironmentOptionsModel.settings(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(createEnvironmentOptionsModel.outputs(), new java.util.ArrayList<VariableData>(java.util.Arrays.asList(variableDataModel)));
    assertEquals(createEnvironmentOptionsModel.sysLock(), systemLockModel);
    assertEquals(createEnvironmentOptionsModel.userState(), environmentUserStateModel);
    assertEquals(createEnvironmentOptionsModel.state(), environmentStateModel);
  }
