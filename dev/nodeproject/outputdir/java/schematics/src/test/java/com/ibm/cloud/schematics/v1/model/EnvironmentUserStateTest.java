...
public class EnvironmentUserStateTest {
  ...
  public void testEnvironmentUserState() throws Throwable {
    ...
    assertEquals(environmentUserStateModelNew.state(), "Environment_Create_Init");
    assertEquals(environmentUserStateModelNew.setBy(), "testString");
    assertEquals(environmentUserStateModelNew.setAt(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
  }
}