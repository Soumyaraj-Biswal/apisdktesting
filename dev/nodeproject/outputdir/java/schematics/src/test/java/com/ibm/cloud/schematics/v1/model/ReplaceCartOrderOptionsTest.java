...
import com.ibm.cloud.schematics.v1.model.ReplaceCartOrderOptions;
...
public class ReplaceCartOrderOptionsTest {
  ...
  public void testReplaceCartOrderOptions() throws Throwable {
    ...
    assertEquals(replaceCartOrderOptionsModel.name(), "MySatelliteLocation");
    assertEquals(replaceCartOrderOptionsModel.description(), "Creates satellite location in AWS");
    assertEquals(replaceCartOrderOptionsModel.tags(), new java.util.ArrayList<String>(java.util.Arrays.asList("testString")));
    assertEquals(replaceCartOrderOptionsModel.cartItems(), new java.util.ArrayList<OrderItemConfiguration>(java.util.Arrays.asList(orderItemConfigurationModel)));
    assertEquals(replaceCartOrderOptionsModel.serviceName(), "SatelliteLocation");
    assertEquals(replaceCartOrderOptionsModel.resourceGroup(), "testString");
    assertEquals(replaceCartOrderOptionsModel.location(), "us-south");
    assertEquals(replaceCartOrderOptionsModel.userState(), cartOrderUserStateModel);
    assertEquals(replaceCartOrderOptionsModel.sysLock(), systemLockModel);
    assertEquals(replaceCartOrderOptionsModel.state(), cartOrderLiteStateModel);
