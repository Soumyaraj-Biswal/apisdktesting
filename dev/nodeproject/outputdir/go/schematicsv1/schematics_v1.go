...
func (schematics *SchematicsV1) CreateAction(createActionOptions *CreateActionOptions) (result *ActionList, response *core.DetailedResponse, err error) {
...
func (schematics *SchematicsV1) CreateActionWithContext(ctx context.Context, createActionOptions *CreateActionOptions) (result *ActionList, response *core.DetailedResponse, err error) {
...
// action state diagram](/docs/schematics?topic=schematics-action-setup#action-state-diagram).
//  **Note** you cannot update the location and region once an action is created.
//  Also, make sure your IP addresses are in the [allowlist](/docs/schematics?topic=schematics-allowed-ipaddresses].
//
//  <h3>Authorization</h3>
...
// Create the IBM Cloud Schematics job to launch an Ansible playbook against a target hosts. The job displays a list of
// jobs with the status as `in_progess`, `success`, or `failed`.
...
// get](/docs/schematics?topic=schematics-schematics-cli-reference#schematics-get-inv). **Note** you can fetch only the
// location and region, resource group from where your inventory is created.
//  Also, make sure your IP addresses are in the [allowlist](/docs/schematics?topic=schematics-allowed-ipaddresses).
//
// <h3>Authorization</h3> Schematics support generic authorization such as service access or platform access to an
// action ID and the resource group. For more information, about Schematics access and permissions, see [Schematics
...
// update](/docs/schematics?topic=schematics-schematics-cli-reference#schematics-update-inv). **Note** you cannot update
// the location and region, resource group once an action is created.
//  Also, make sure your IP addresses are in the [allowlist](/docs/schematics?topic=schematics-allowed-ipaddresses).
//
// <h3>Authorization</h3> Schematics support generic authorization such as service access or platform access to an
// action ID and the resource group. For more information, about Schematics access and permissions, see  [Schematics
...
// delete](/docs/schematics?topic=schematics-schematics-cli-reference#schematics-delete-inventory). **Note** you cannot
// delete the location and region, resource group from where your inventory is created.
//  Also, make sure your IP addresses are in the [allowlist](/docs/schematics?topic=schematics-allowed-ipaddresses).
//
// <h3>Authorization</h3> Schematics support generic authorization such as service access or platform access to an
// action ID and the resource group. For more information, about Schematics access and permissions, see  [Schematics
...
func (options *ApplyWorkspaceCommandOptions) SetDelegatedToken(delegatedToken string) *ApplyWorkspaceCommandOptions {
	options.DelegatedToken = core.StringPtr(delegatedToken)
	return options
}
...
// SetDestroyResources : Allow user to set DestroyResources
func (options *DeleteWorkspaceOptions) SetDestroyResources(destroyResources bool) *DeleteWorkspaceOptions {
	options.DestroyResources = core.BoolPtr(destroyResources)
	return options
}
...
// SetDelegatedToken : Allow user to set DelegatedToken
func (options *DestroyWorkspaceCommandOptions) SetDelegatedToken(delegatedToken string) *DestroyWorkspaceCommandOptions {
	options.DelegatedToken = core.StringPtr(delegatedToken)
	return options
}
...
// ExternalSourceCosBucket : The connection details to the IBM Cloud Object Storage bucket.
...
// SetDelegatedToken : Allow user to set DelegatedToken
func (options *PlanWorkspaceCommandOptions) SetDelegatedToken(delegatedToken string) *PlanWorkspaceCommandOptions {
	options.DelegatedToken = core.StringPtr(delegatedToken)
	return options
}
...
func (options *ProcessTemplateMetaDataOptions) SetTemplateType(templateType string) *ProcessTemplateMetaDataOptions {
	options.TemplateType = core.StringPtr(templateType)
	return options
}

// SetSource : Allow user to set Source
func (options *ProcessTemplateMetaDataOptions) SetSource(source *ExternalSource) *ProcessTemplateMetaDataOptions {
	options.Source = source
	return options
}

// SetRegion : Allow user to set Region
func (options *ProcessTemplateMetaDataOptions) SetRegion(region string) *ProcessTemplateMetaDataOptions {
	options.Region = core.StringPtr(region)
	return options
}

// SetSourceType : Allow user to set SourceType
func (options *ProcessTemplateMetaDataOptions) SetSourceType(sourceType string) *ProcessTemplateMetaDataOptions {
	options.SourceType = core.StringPtr(sourceType)
	return options
}

// SetXGithubToken : Allow user to set XGithubToken
func (options *ProcessTemplateMetaDataOptions) SetXGithubToken(xGithubToken string) *ProcessTemplateMetaDataOptions {
	options.XGithubToken = core.StringPtr(xGithubToken)
	return options
}
...
// SetDelegatedToken : Allow user to set DelegatedToken
func (options *RefreshWorkspaceCommandOptions) SetDelegatedToken(delegatedToken string) *RefreshWorkspaceCommandOptions {
	options.DelegatedToken = core.StringPtr(delegatedToken)
	return options
}
...
// SetWID : Allow user to set WID
func (options *TemplateRepoUploadOptions) SetWID(wID string) *TemplateRepoUploadOptions {
	options.WID = core.StringPtr(wID)
	return options
}

// SetTID : Allow user to set TID
func (options *TemplateRepoUploadOptions) SetTID(tID string) *TemplateRepoUploadOptions {
	options.TID = core.StringPtr(tID)
	return options
}

// SetFile : Allow user to set File
func (options *TemplateRepoUploadOptions) SetFile(file io.ReadCloser) *TemplateRepoUploadOptions {
	options.File = file
	return options
}

// SetFileContentType : Allow user to set FileContentType
func (options *TemplateRepoUploadOptions) SetFileContentType(fileContentType string) *TemplateRepoUploadOptions {
...
// SetCommandObject : Allow user to set CommandObject
func (options *UpdateJobOptions) SetCommandObject(commandObject string) *UpdateJobOptions {
	options.CommandObject = core.StringPtr(commandObject)
	return options
}

// SetCommandObjectID : Allow user to set CommandObjectID
func (options *UpdateJobOptions) SetCommandObjectID(commandObjectID string) *UpdateJobOptions {
	options.CommandObjectID = core.StringPtr(commandObjectID)
	return options
}

// SetCommandName : Allow user to set CommandName
func (options *UpdateJobOptions) SetCommandName(commandName string) *UpdateJobOptions {
	options.CommandName = core.StringPtr(commandName)
	return options
}

// SetCommandParameter : Allow user to set CommandParameter
func (options *UpdateJobOptions) SetCommandParameter(commandParameter string) *UpdateJobOptions {
	options.CommandParameter = core.StringPtr(commandParameter)
	return options
}

// SetCommandOptions : Allow user to set CommandOptions
func (options *UpdateJobOptions) SetCommandOptions(commandOptions []string) *UpdateJobOptions {
	options.CommandOptions = commandOptions
	return options
}

// SetInputs : Allow user to set Inputs
func (options *UpdateJobOptions) SetInputs(inputs []VariableData) *UpdateJobOptions {
	options.Inputs = inputs
	return options
}

// SetSettings : Allow user to set Settings
func (options *UpdateJobOptions) SetSettings(settings []VariableData) *UpdateJobOptions {
	options.Settings = settings
	return options
}

// SetTags : Allow user to set Tags
func (options *UpdateJobOptions) SetTags(tags []string) *UpdateJobOptions {
	options.Tags = tags
	return options
}

// SetLocation : Allow user to set Location
func (options *UpdateJobOptions) SetLocation(location string) *UpdateJobOptions {
	options.Location = core.StringPtr(location)
	return options
}

// SetStatus : Allow user to set Status
func (options *UpdateJobOptions) SetStatus(status *JobStatus) *UpdateJobOptions {
	options.Status = status
	return options
}

// SetData : Allow user to set Data
func (options *UpdateJobOptions) SetData(data *JobData) *UpdateJobOptions {
	options.Data = data
	return options
}

// SetBastion : Allow user to set Bastion
func (options *UpdateJobOptions) SetBastion(bastion *BastionResourceDefinition) *UpdateJobOptions {
	options.Bastion = bastion
	return options
}

// SetLogSummary : Allow user to set LogSummary
func (options *UpdateJobOptions) SetLogSummary(logSummary *JobLogSummary) *UpdateJobOptions {
	options.LogSummary = logSummary
	return options
}
...
// SetLocation : Allow user to set Location
func (options *UpdateKmsSettingsOptions) SetLocation(location string) *UpdateKmsSettingsOptions {
	options.Location = core.StringPtr(location)
	return options
}

// SetEncryptionScheme : Allow user to set EncryptionScheme
func (options *UpdateKmsSettingsOptions) SetEncryptionScheme(encryptionScheme string) *UpdateKmsSettingsOptions {
	options.EncryptionScheme = core.StringPtr(encryptionScheme)
	return options
}

// SetResourceGroup : Allow user to set ResourceGroup
func (options *UpdateKmsSettingsOptions) SetResourceGroup(resourceGroup string) *UpdateKmsSettingsOptions {
	options.ResourceGroup = core.StringPtr(resourceGroup)
	return options
}

// SetPrimaryCrk : Allow user to set PrimaryCrk
func (options *UpdateKmsSettingsOptions) SetPrimaryCrk(primaryCrk *KMSSettingsPrimaryCrk) *UpdateKmsSettingsOptions {
	options.PrimaryCrk = primaryCrk
	return options
}

// SetSecondaryCrk : Allow user to set SecondaryCrk
func (options *UpdateKmsSettingsOptions) SetSecondaryCrk(secondaryCrk *KMSSettingsSecondaryCrk) *UpdateKmsSettingsOptions {
