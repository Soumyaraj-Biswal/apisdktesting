...
class SchematicsV1(BaseService):
    ...
    def process_template_meta_data(self,
        ...
        **kwargs
        ...
        :param str x_github_token: (optional) The personal access token associated
               with your GitHub or GitLab repository, required to clone the repository.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def get_workspace(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve
               detailed information. To find the workspace ID, use the `GET
               /v1/workspaces` API.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `WorkspaceResponse` object
    ...
    def replace_workspace(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace that you want to update. To find
               the ID, use the `GET /v1/workspaces` API.
        :param CatalogRef catalog_ref: (optional) Information about the software
               template that you chose from the IBM Cloud catalog. This information is
               returned for IBM Cloud catalog offerings only.
        :param str description: (optional) The description of the workspace.
    ...
    def delete_workspace(self,
        ...
        **kwargs
         ...
         **Note**: If you delete a workspace without deleting the resources, you must
        manage your resources with the resource dashboard or CLI afterwards. You cannot
        use IBM Cloud Schematics anymore to manage your resources.
         <h3>Authorization</h3>
         Schematics support generic authorization such as service access or platform
        access to the workspace ID and the resource group. For more information, about
        Schematics access and permissions, see [Schematics service access roles and
        ...
        :param str w_id: The ID of the workspace that you want to delete. To find
               the workspace ID, use the `GET /v1/workspaces` API.
        :param bool destroy_resources: (optional) If set to `true`, refresh token
        ...
        :param str refresh_token: (optional) The IAM refresh token is required only
               if you want to delete all the Terraform resources before deleting the
               Schematics workspace. If you want to delete the workspace only and keep all
               your Terraform resources, refresh token is not required.
    ...
    def get_workspace_readme(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve the
               `README.md` file that is stored in the GitHub or GitLab repository that
               your workspace points to. To find the workspace ID, use the `GET
               /v1/workspaces` API.
    ...
    def get_workspace_inputs(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve the
               input variables that you declared in your Terraform template. To find the
               workspace ID, use the `GET /v1/workspaces` API.
        :param str t_id: The ID of the Terraform template for which you want to
               retrieve all your input variables. When you create a workspace, the
    ...
    def get_all_workspace_inputs(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve
               information about the associated Terraform template. To find the workspace
               ID, use the `GET /v1/workspaces` API.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def get_workspace_outputs(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve
               output values. To find the workspace ID, use the `GET /workspaces` API.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def get_workspace_resources(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve
               details.  To find the workspace ID, use the `GET /workspaces` API.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def get_workspace_state(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve the
               Terraform statefile URL.  To find the workspace ID, use the GET
               /v1/workspaces API.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def get_template_logs(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to retrieve
               details.  To find the workspace ID, use the `GET /workspaces` API.
        :param str t_id: The ID that was assigned to your Terraform template or IBM
               Cloud catalog software template.  To find the ID, use the GET
               /v1/workspaces API.
    ...
    def create_action(self,
        ...
        **kwargs
        ...
        [allowlist](/docs/schematics?topic=schematics-allowed-ipaddresses).
         <h3>Authorization</h3>
         Schematics support generic authorization such as service access or
         platform access to an action ID and the resource group.
         For more information, about Schematics access and permissions, see
        ...
        :param VariableData bastion_credential: (optional) User editable variable
               data and system generated reference to the value.
    ...
    def get_action(self,
        ...
        **kwargs
        ...
        API returns a URL to the log file that you can retrieve by using  the\_ `GET
    ...
    def upload_template_tar_action(self,
        ...
        **kwargs
        ...
        GitHub or GitLab repository with the\_POST /v2/actions\_API.
        <h3>Authorization</h3>  Schematics support generic authorization such as service
    ...
    def apply_workspace_command(self,
        ...
        **kwargs
        ...
        is [persisted](/docs/schematics?topic=schematics-persist-files) to determine what
        ...
        applied, the state of the files is
        [persisted](/docs/schematics?topic=schematics-persist-files) to determine what
        resources exist in your IBM Cloud account.
         **Note**: This API returns an activity or job ID that you use to retrieve the log
        URL with the `GET /v1/workspaces/{id}/actions/{action_id}/logs` API.
         **Important:** Applying a template might incur costs. Make sure to review the
        pricing information for the resources that you specified in your templates before
        you apply the template in IBM Cloud. To find a summary of job that Schematics is
        about to perform, create a Terraform execution plan with the `POST
        /v1/workspaces/{id}/plan` API.
         <h3>Authorization</h3>
         Schematics support generic authorization such as service access or platform
        access to the workspace ID and the resource group. For more information, about
        Schematics access and permissions, see [Schematics service access roles and
        ...
        :param str w_id: The ID of the workspace for which you want to run a
               Schematics `apply` job. To find the workspace ID, use the `GET /workspaces`
               API.
        :param str refresh_token: The IAM refresh token is required only if you
               want to delete all the Terraform resources before deleting the Schematics
               workspace. If you want to delete the workspace only and keep all your
        ...
        :param str delegated_token: (optional) The IAM delegated token for your IBM
               Cloud account. This token is required for requests that are sent via the UI
               only.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `WorkspaceActivityApplyResult` object
    ...
    def refresh_workspace_command(self,
        ...
        **kwargs
        ...
        :param str w_id: The ID of the workspace for which you want to perform a
               Schematics `refresh` job. To find the workspace ID, use the `GET
               /workspaces` API.
        :param str refresh_token: The IAM refresh token is required only if you
               want to delete all the Terraform resources before deleting the Schematics
               workspace. If you want to delete the workspace only and keep all your
    ...
    def list_jobs(self,
        ...
        **kwargs
        ...
        status as `in_progess`,  `success`, or `failed`. Jobs are generated when you use
        the  `POST /v2/jobs`, `PUT /v2/jobs/{job_id}`, or `DELETE /v2/jobs/{job_id}`.
         <h3>Authorization</h3>
         Schematics support generic authorization such as service access or
    ...
    def create_job(self,
        ...
        **kwargs
        ...
        Create the IBM Cloud Schematics job to launch an Ansible playbook against a target
        hosts. The job displays a list of jobs with the status as `in_progess`, `success`,
        or `failed`.
    ...
    def update_job(self,
        ...
        **kwargs
        ...
        Update or replace a job creates a copy of the job and relaunches an existing job
        by updating the information of an existing Schematics job.
         <h3>Authorization</h3>
         Schematics support generic authorization such as service access or
         platform access to the job ID and the resource group.
         For more information, about Schematics access and permissions, see
    ...
    def create_inventory(self,
        ...
        **kwargs
        ...
        Schematics actions](/docs/schematics?topic=schematics-inventories-setup). **Note**
        you cannot update the location and region, resource group once an action is
        created.  Also, make sure your IP addresses are in the
        [allowlist](/docs/schematics?topic=schematics-allowed-ipaddresses).  If your Git
        repository already contains a host file. Schematics does not  overwrite the host
        file already present in your Git repository.
        <h3>Authorization</h3> Schematics support generic authorization such as service
        access or platform access to an action ID and the resource group. For more
        information, about Schematics access and permissions, see  [Schematics service
        access roles and required
        ...
        :param str name: (optional) The unique name of your Inventory resource. The
               name can be up to 128 characters long and can include alphanumeric
               characters, spaces, dashes, and underscores.
        :param str description: (optional) The description of your Inventory
               resource. The description can be up to 2048 characters long in size.
        :param str location: (optional) List of locations supported by IBM Cloud
               Schematics service.  While creating your workspace or action, choose the
               right region, since it cannot be changed.  Note, this does not limit the
               location of the IBM Cloud resources, provisioned using Schematics.
        :param str resource_group: (optional) Resource-group name for the Inventory
               resource.  By default, Action will be created in Default Resource Group.
    ...
    def delete_inventory(self,
        ...
        **Note** you cannot delete the location and region, resource group from where your
    ...
    def create_resource_query(self,
        ...
        **kwargs
        ...
        create](/docs/schematics?topic=schematics-schematics-cli-reference#schematics-create-rq).
...
class Action():
    ...
    :attr VariableData bastion_credential: (optional) User editable variable data
          and system generated reference to the value.
...
class ExternalSource():
    ...
    :attr ExternalSourceCosBucket cos_bucket: (optional) The connection details to
          the IBM Cloud Object Storage bucket.
    """
    ...
    def __init__(self,
        ...
        :param ExternalSourceCosBucket cos_bucket: (optional) The connection
               details to the IBM Cloud Object Storage bucket.
        """
        self.source_type = source_type
        self.git = git
...
class ExternalSourceCosBucket():
    ...
    :attr str cos_bucket_url: (optional) The COS bucket URL.
    """
    ...
    def __init__(self,
        ...
        :param str cos_bucket_url: (optional) The COS bucket URL.
        """
...
class ExternalSourceGit():
    ...
    :attr str git_token: (optional) The personal access token to connect to the Git
          URLs.
    ...
    def __init__(self,
        ...
        :param str git_token: (optional) The personal access token to connect to
               the Git URLs.
...
class TemplateMetaDataResponse():
    ...
    :attr str type: (optional) The template type such as **terraform**, **ansible**,
          **helm**, **cloudpak**, or **bash script**.
